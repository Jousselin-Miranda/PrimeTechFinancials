...
public class ItemsManagement_steps {
	...
	public void i_provide_item_information_name_price_unit_and_description(String name, String price, String unit, String description) {
		itemName = name;
		item_page.items_page_name_box.sendKeys(itemName);
	...
	public void the_item_is_added_to_the_item_list_table() {
		...
		utils.waitForElemenToBeVisibleWithLocator(By.xpath("//a[contains(text(), '" + itemName +"')]"));
	...
	public void i_delete_the_item() throws InterruptedException {
		...
		utils.waitForElementToBeVisible(item_page.item_input_delete_youSure_text);
		Assert.assertTrue(item_page.item_input_delete_youSure_text.isDisplayed());
