...
public class ItemsPage {
		...
		@FindBy (xpath = "//div[@class='relative_rounded-md shadow-sm font-base']/input")
		public WebElement items_page_name_box;
		...
		@FindBy (xpath = "//xpath = //button[text()=' save Item']")
		...
		public WebElement item_input_delete_youSure_text;
